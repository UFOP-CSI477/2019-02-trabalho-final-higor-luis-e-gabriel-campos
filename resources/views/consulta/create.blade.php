@extends('layouts.app', ['activePage' => 'cosulta-management', 'titlePage' => __('Gerenciar Consultas')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('consulta.store') }}" autocomplete="off" class="form-horizontal">
                    @csrf
                    @method('post')
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <a href="{{ route('consulta.index') }}" class="btn btn-primary btn-bg">{{ __('Voltar para a lista') }}</a>
